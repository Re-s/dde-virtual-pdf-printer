...
- ✅ **系统卸载入口**：随包安装 `.desktop` 桌面入口（deepin 应用中心识别为可卸载应用），点击直达插件页
...
wget https://github.com/Re-s/dde-virtual-pdf-printer/releases/download/v0.8.7/dde-pdf-printer_0.8.7_amd64.deb
sudo dpkg -i dde-pdf-printer_0.8.7_amd64.deb
```
...
**Release**：https://github.com/Re-s/dde-virtual-pdf-printer/releases/tag/v0.8.7 （三架构 deb 包 + 截图，GitHub Actions 自动构建发布）
